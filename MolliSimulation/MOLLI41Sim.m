%[oSig, oTinv]= MOLLI41Sim(HRs, iT1, iT2, invEff, ioffFre, iB1Scale)
% Simulate Molli5(3)3 T1 mapping sequence
%
%[oSig, oTinv] = MOLLI41Sim(HRs, iT1, iT2)
%[oSig, oTinv] = MOLLI41Sim(HRs, iT1, iT2, invEff)
%[oSig, oTinv] = MOLLI41Sim(HRs, iT1, iT2, invEff, ioffFre)
%[oSig, oTinv] = MOLLI41Sim(HRs, iT1, iT2, invEff, ioffFre, iB1Scale)
%
%Input
...
% by Rui Guo
function [oflg, oSig, oTinv] = MOLLI41Sim(HRs, iT1, iT2, invEff, ioffFre, iB1Scale)
...
%1(inv+ACQ)-2(ACQ)-3(ACQ)-4(ACQ)-5(inv+ACQ)
%set the Tinv timing
...
if(delayBwnInvAcq2>triggerDealyArrs(5))
    delayBwnInvAcq2 = triggerDealyArrs(5);
