...
for ii = 1: myoLen
    ...
    if(iT1<1000)
        ...
        subjectsLists(sliceCount,:) = char(['Different_Myo_T1_' num2str(iT1) '_____'])
    else
...
%Myo T1 = 700;
%blood T1 = 400;
myoT1 = 700*ones(1,myoLen);
bpT1 = 400*ones(1,myoLen);
...
save([matPath filesep 'allSim_post_T1map_50_50_SL5_Testing.mat'], ...
    'Pre5HBsT1wTIs',...
    'Pre5HBsBPMask',...
    'Pre5HBsMyoMask',...
    'Pre5HBsSepMask',...
